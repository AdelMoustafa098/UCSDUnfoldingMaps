...
import de.fhpotsdam.unfolding.providers.Google.GoogleProvider;
...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// create a new unfolding map object
		map2 = new UnfoldingMap(this, 420, 50, 350, 500, provider);
		// this line zooms in and centers the map at 
		map2.zoomAndPanTo(zoomLevel, new Location(29.9, 31.0));
		// This line makes the map interactive
